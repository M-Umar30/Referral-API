...
function ViewReferrals() {
  const referrals = [
    {
      ...
      title: "Referral 1",
      description:
        "This is the first referralContrary to popular belief, Lorem Ipsum isasdfjhalsdfjhasjkdfhlaksjfhalsjkdfhasldfjhaks ",
    },
    {
      id: 2,
      title: "Referral 2",
  ...
  return (
    <div className="scrollable-feed">
      <ReferralCard referrals={referrals} likeControl={false} />
    </div>
  );
}
